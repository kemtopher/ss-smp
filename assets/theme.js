...
// (function () {
  // if (localStorage.getItem("user_zip_code")) {
  //   console.log("... getting localStorage");

  //   return localStorage.getItem("user_zip_code");
  // }
//   fetch("https://garden.org/api/v1/zipcodes/10001?api_key=YOUR_API_KEY")
// .then(response => response.json())
// .then(data => console.log("Hardiness Zone:", data.hardiness_zone))
// .catch(error => console.error("Error:", error));

// async function cacheProductsByZip(data) {
//   try {
//     let cachedProducts = localStorage.getItem("cached_products_by_zip");

//     if (cachedProducts) {

//       // check TTL for Date() + 300000ms (5 mins)
...
//   localStorage.setItem("cached_products_by_zip", JSON.stringify(data));
//   return data;
// }
// document.addEventListener("DOMContentLoaded", async () => {});
  ...
  // on page open check for geolocation ability
  // if permission to local
  // - get local
  // 

  // check for browser navigator compatibility
  // ask to allow location access
  // return postal code from ipapi
  ...
  // const setSessionZipCode = (data) => {
  //   let sessionZipCode = sessionStorage.getItem("session_zip_code");
    
  //   const zipCode = fetchZipCode(); //30316
  //   return sessionStorage.setItem("user_session_zip_code", {...data.postal, zipTtl: new Date.now()});
  // }

  // sessionStorage.setItem("session_zip_code", );
// })();